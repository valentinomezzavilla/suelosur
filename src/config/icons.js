...
// Set de íconos de línea (Feather-style), monocromáticos (heredan currentColor).
// Uso en vistas: <%- icon('clientes') %>  ó  <%- icon('edit', { size: 15 }) %>
const ICONS = {
...
function icon(name, opts = {}) {
  ...
  const cls  = opts.class ? `ic ${opts.class}` : 'ic'
